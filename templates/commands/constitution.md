---
description: Cria ou atualiza a constituição do projeto (princípios específicos que estendem o playbook gherkin-sdd).
---

# /constitution

Você vai estabelecer (ou revisar) a **constituição** deste projeto em
`.gherkin-sdd/memory/constitution.md`. Ela estende o playbook gherkin-sdd (SDD, Gherkin,
...
## Faça
1. Leia `.gherkin-sdd/memory/constitution.md` se já existir. Não jogue fora o que está lá;
   evolua.
...
3. Escreva `.gherkin-sdd/memory/constitution.md` curto e acionável. Cada regra deve ser
...
## Saída
- `.gherkin-sdd/memory/constitution.md` atualizado.
