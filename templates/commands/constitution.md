...
`.gherkin-sdd/constitution.md`. Ela estende o playbook gherkin-sdd (SDD, Gherkin,
...
## Faça
1. Leia `.gherkin-sdd/constitution.md` se já existir. Não jogue fora o que está lá;
   evolua.
...
3. Escreva `.gherkin-sdd/constitution.md` curto e acionável. Cada regra deve ser
...
## Saída
- `.gherkin-sdd/constitution.md` atualizado.
